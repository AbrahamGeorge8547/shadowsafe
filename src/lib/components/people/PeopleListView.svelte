...
<div
  class="flex w-full h-[50px] border-0 justify-center items-center !border-b-0"
>
  <div
    class="w-full flex rounded-full !h-[40px] searchWrapper justify-center items-center border border-[#4C598B4D] mx-2 my-2 !bg-[#262C44]"
  >
    <input
      type="search"
...
<ul class="w-full !text-xs !font-light bg-[#2E3654]">
  {#each filteredPeoples as person}
    ...
    >
      <span
        class="rounded-full w-[24px] h-[24px] flex justify-center items-center bg-[#4C598B33] mx-2"
      >
        <Icon icon="tabler:user" class="text-3xl h-[15px] w-[15px]" />
      </span>
