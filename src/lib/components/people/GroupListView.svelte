...
<div class="bg-[#262C44] rounded-lg">
  <div class="px-3 py-3 mb-2">
    <h2 class="ml-4 mb-2 text-3xl">Drag and Drop to give access</h2>
    <RadioGroup
      active="bg-[#4C598B]"
      hover="hover:bg-[#4C598B33]"
    ...
    >
      <RadioItem bind:group={value} name="justify" value="Users"
        >All Users</RadioItem
      >
      <RadioItem bind:group={value} name="justify" value="Groups"
        >Groups</RadioItem
      >
    </RadioGroup>
  </div>
  ...
  <div
    class="flex w-full h-[50px] border border-[#4C598B4D] justify-center items-center !border-b-0"
  >
    <div
      class="w-full flex rounded-full !h-[40px] searchWrapper justify-center items-center border border-[#4C598B4D] mx-2 my-2"
    >
      <input
        type="search"
  ...
  <ul class="w-full !text-xs !font-light">
    {#each filteredList as element}
      <div
        class="flex justify-center items-center pl-4 border border-[#4C598B4D] border-b-0 py-[6px]"
      >
        <span
